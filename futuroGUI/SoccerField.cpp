...
SoccerField::SoccerField(float windowWidth, float windowHeight) {
...
void SoccerField::addObjectToField(QGraphicsItem *object, float x, float y) {
...
void SoccerField::addBolaToCenter(Ball *bola) {
...
void SoccerField::addRobosToSides(Robot *robot, int numRobos) {
